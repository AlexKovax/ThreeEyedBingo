...
let tabCharacters = [
    ...
    { id: 'jaime', name: 'Jaime Lannister', info: '', deadAtEpisode: 5, isDead: true, dateOfDeath: new Date(('2019-05-13T03:00:00')) },
    ...
    { id: 'mountain', name: 'The Mountain', info: '', deadAtEpisode: 5, isDead: true, dateOfDeath: new Date(('2019-05-13T03:00:00')) },
    { id: 'varys', name: 'Varys', info: '', deadAtEpisode: 5, isDead: true, dateOfDeath: new Date(('2019-05-13T03:00:00')) },
    ...
    { id: 'euron', name: 'Euron Greyjoy', info: '', deadAtEpisode: 5, isDead: true, dateOfDeath: new Date(('2019-05-13T03:00:00')) },
    { id: 'hound', name: 'The Hound', info: '', deadAtEpisode: 5, isDead: true, dateOfDeath: new Date(('2019-05-13T03:00:00')) },
    ...
    { id: 'qyburn', name: 'Qyburn', info: '', deadAtEpisode: 5, isDead: true, dateOfDeath: new Date(('2019-05-13T03:00:00')) },
