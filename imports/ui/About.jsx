        ...
        return (
            <div>
                ...
                <Segment loading={this.state.loading}>
                    ...
                    <p>This is a small friendly project that was created over a few days. We wanted to launch fast so that people can make their predictions before the first episode.</p>
